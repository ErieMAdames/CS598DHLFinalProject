...
- **Tutorial**: `Introduction to pyhealth.tasks <https://colab.research.google.com/drive/1r7pku7uMlJOECNMDU7A9C99rjOg3Kfhk>`_ - Learn the basics of defining and using tasks
...
.. toctree::
 ...
 Base Task <tasks/pyhealth.tasks.base_task>
 In-Hospital Mortality (MIMIC-IV) <tasks/pyhealth.tasks.inhospital_mortality_mimic4_fn>
 MIMIC-III ICD-9 Coding <tasks/pyhealth.tasks.mimic3_icd9_coding>
 Cardiology Detection <tasks/pyhealth.tasks.cardiology_detection>
 COVID-19 CXR Classification <tasks/pyhealth.tasks.covid19_cxr_classification>
 DKA Prediction (MIMIC-IV) <tasks/pyhealth.tasks.dka_prediction_mimic4_fn>
 ...
 Medical Transcriptions Classification <tasks/pyhealth.tasks.medical_transcriptions_classification>
 ...
 Patient Linkage (MIMIC-III) <tasks/pyhealth.tasks.patient_linkage>
 Readmission Prediction <tasks/pyhealth.tasks.readmission_prediction>
 Sleep Staging <tasks/pyhealth.tasks.sleep_staging>
 Sleep Staging (SleepEDF) <tasks/pyhealth.tasks.sleep_staging_sleepedf>
 ...
 ChestX-ray14 Binary Classification <tasks/pyhealth.tasks.chestxray14_binary_classification>
 ChestX-ray14 Multilabel Classification <tasks/pyhealth.tasks.chestxray14_multilabel_classification>
 Variant Classification (ClinVar) <tasks/pyhealth.tasks.clinvar_variant_classification>
